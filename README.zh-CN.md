...
最新完成本地验证的版本：`ChatGPT.app` / `Codex.app` `26.721.41059`（`build 5848`）。

另已验证支持 `ChatGPT.app` / `Codex.app` `26.721.31836`（`build 5828`）、`26.721.30844`（`build 5813`）、`26.715.72359`（`build 5718`）和 `26.715.72028`（`build 5706`）。
