...
已验证兼容：`Codex.app` `26.415.40636`（`build 1799`）、`26.417.41555`（`build 1858`）、`26.422.21637`（`build 2056`）、`26.422.30944`（`build 2080`）和 `26.422.62136`（`build 2176`）。能力定义见 [`docs/feature-scope.md`](./docs/feature-scope.md)。
...
- 已验证版本：`Codex.app` `26.422.62136`（`build 2176`）
