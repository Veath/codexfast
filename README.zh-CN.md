...
最新完成本地验证的版本：`ChatGPT.app` / `Codex.app` `26.715.72028`（`build 5706`）。

另已验证支持 `ChatGPT.app` / `Codex.app` `26.715.70719`（`build 5650`）。

已验证支持 `ChatGPT.app` / `Codex.app` `26.715.61943`（`build 5628`）、`26.715.52143`（`build 5591`）、`26.715.31925`（`build 5551`）、`26.715.21425`（`build 5488`）、`26.707.91948`（`build 5440`）、`26.707.72221`（`build 5307`）、`26.707.71524`（`build 5263`）、`26.707.61608`（`build 5200`）、`26.707.41301`（`build 5103`）、`26.707.31428`（`build 5059`）、`26.623.141536`（`build 4753`）、`26.623.101652`（`build 4674`）、`26.623.81905`（`build 4598`）、`26.623.70822`（`build 4559`）、`26.623.61825`（`build 4548`）、`26.623.42026`（`build 4514`）、`26.623.31921`（`build 4452`）、`26.623.31443`（`build 4441`）、`26.616.81150`（`build 4306`）、`26.616.71553`（`build 4265`）、`26.616.51431`（`build 4212`）、`26.616.31447`（`build 4133`）、`26.611.62324`（`build 4028`）、`26.611.61753`（`build 4008`）、`26.611.61049`（`build 3996`）、`26.609.71450`（`build 3965`）、`26.609.41114`（`build 3888`）、`26.609.30741`（`build 3808`）、`26.608.12217`（`build 3722`）、`26.602.71036`（`build 3685`）、`26.602.40724`（`build 3593`）、`26.602.30954`（`build 3575`）、`26.601.21317`（`build 3511`）、`26.527.60818`（`build 3437`）、`26.527.31326`（`build 3390`）、`26.519.81530`（`build 3178`）、`26.519.41501`（`build 3044`）、`26.519.31651`（`build 3017`）、`26.519.22136`（`build 3003`）、`26.513.31313`（`build 2867`）、`26.513.20950`（`build 2816`）、`26.506.31421`（`build 2620`）、`26.506.21252`（`build 2575`）、`26.429.61741`（`build 2429`）、`26.429.30905`（`build 2345`）、`26.429.20946`（`build 2312`）、`26.422.71525`（`build 2210`）、`26.422.62136`（`builds 2180, 2176`）、`26.422.30944`（`build 2080`）、`26.422.21637`（`build 2056`）、`26.417.41555`（`build 1858`）和 `26.415.40636`（`build 1799`）。功能范围见 [`docs/feature-scope.md`](./docs/feature-scope.md)。
