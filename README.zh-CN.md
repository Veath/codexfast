...
另已验证支持 `ChatGPT.app` / `Codex.app` `26.730.61309`（`build 6223`）、`26.727.51351`（`build 6119`）、`26.727.40816`（`build 6067`）、`26.721.81911`（`build 5973`）、`26.721.41059`（`build 5848`）、`26.721.31836`（`build 5828`）、`26.721.30844`（`build 5813`）、`26.715.72359`（`build 5718`）和 `26.715.72028`（`build 5706`）。
