...
- Added local compatibility for `ChatGPT.app` `26.825.51511` (`build 7377`). Existing Fast, `/fast`, Settings update-row, settings schema, and source-signature updater paths remain compatible; GPT-5.6 and Plugins use official application paths.

## [0.78.0] - 2026-08-30

### Added

- Added local compatibility for `ChatGPT.app` `26.825.41651` (`build 7345`). Existing Fast, `/fast`, Settings update-row, settings schema, and source-signature updater paths remain compatible; GPT-5.6 and Plugins use official application paths.
...
- Added local compatibility for `ChatGPT.app` `26.810.41047` (`build 6570`) after read-only bundle inspection confirmed the existing Fast and automatic-update target family remains compatible; GPT-5.6 and Plugins continue to use official application paths.
...
- Added local compatibility for `ChatGPT.app` `26.721.81911` (`build 5973`) after direct installed-bundle inspection confirmed the build-5848 Fast and automatic-update target family remains compatible while GPT-5.6 and Plugins continue to use official application paths.
...
- Added local compatibility for `ChatGPT.app` `26.715.72028` (`build 5706`) after direct installed-bundle inspection confirmed the 26.715 Fast and automatic-update target family remains compatible while GPT-5.6 and Plugins continue to use official application paths.
...
- Added local compatibility for `ChatGPT.app` `26.715.61943` (`build 5628`) after direct installed-bundle inspection confirmed the 26.715 Fast and automatic-update target family remains compatible while GPT-5.6 and Plugins continue to use official application paths.

## [0.57.0] - 2026-07-20

### Added

- Added local compatibility for `ChatGPT.app` `26.715.52143` (`build 5591`) after direct installed-bundle inspection confirmed the build-5551 Fast, automatic-update, official GPT-5.6, and official Plugins paths remain compatible with renamed renderer assets.

## [0.56.0] - 2026-07-20

### Added

- Added local compatibility for `ChatGPT.app` `26.715.31925` (`build 5551`) after direct installed-bundle inspection, retaining the guarded Fast and automatic-update targets plus the official GPT-5.6 and Plugins paths.
