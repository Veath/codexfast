...
function main(): void {
  ...
  const nonRunningLaunch2671531925App = join(tmpDir, "NonRunningLaunch2671531925.app");
  const nonRunningLaunch2671531925Output = join(tmpDir, "non-running-launch-26715-31925-output.txt");
  prepareFakeApp(nonRunningLaunch2671531925App, "26.715.31925", "5551");
  runScriptCommand(nonRunningLaunch2671531925App, ["launch"], nonRunningLaunch2671531925Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2671531925Output), "Compatibility: supported", "expected build 5551 to pass the strict support gate", readOutput(nonRunningLaunch2671531925Output));
  assertContains(readOutput(nonRunningLaunch2671531925Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5551 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2671531925Output));
  assertContains(readOutput(nonRunningLaunch2671531925Output), "Contents/MacOS/ChatGPT", "expected supported build 5551 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2671531925Output));
  assertNoLaunchCalls(nonRunningLaunch2671531925Output);
  assertNoBundleMutationTools(nonRunningLaunch2671531925Output);

  const nonRunningLaunch2671552143App = join(tmpDir, "NonRunningLaunch2671552143.app");
  const nonRunningLaunch2671552143Output = join(tmpDir, "non-running-launch-26715-52143-output.txt");
  prepareFakeApp(nonRunningLaunch2671552143App, "26.715.52143", "5591");
  runScriptCommand(nonRunningLaunch2671552143App, ["launch"], nonRunningLaunch2671552143Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2671552143Output), "Compatibility: supported", "expected build 5591 to pass the strict support gate", readOutput(nonRunningLaunch2671552143Output));
  assertContains(readOutput(nonRunningLaunch2671552143Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5591 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2671552143Output));
  assertContains(readOutput(nonRunningLaunch2671552143Output), "Contents/MacOS/ChatGPT", "expected supported build 5591 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2671552143Output));
  assertNoLaunchCalls(nonRunningLaunch2671552143Output);
  assertNoBundleMutationTools(nonRunningLaunch2671552143Output);

  const nonRunningLaunch2671561943App = join(tmpDir, "NonRunningLaunch2671561943.app");
  const nonRunningLaunch2671561943Output = join(tmpDir, "non-running-launch-26715-61943-output.txt");
  prepareFakeApp(nonRunningLaunch2671561943App, "26.715.61943", "5628");
  runScriptCommand(nonRunningLaunch2671561943App, ["launch"], nonRunningLaunch2671561943Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2671561943Output), "Compatibility: supported", "expected build 5628 to pass the strict support gate", readOutput(nonRunningLaunch2671561943Output));
  assertContains(readOutput(nonRunningLaunch2671561943Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5628 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2671561943Output));
  assertContains(readOutput(nonRunningLaunch2671561943Output), "Contents/MacOS/ChatGPT", "expected build 5628 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2671561943Output));
  assertNoLaunchCalls(nonRunningLaunch2671561943Output);
  assertNoBundleMutationTools(nonRunningLaunch2671561943Output);

  const nonRunningLaunch2671570719App = join(tmpDir, "NonRunningLaunch2671570719.app");
  const nonRunningLaunch2671570719Output = join(tmpDir, "non-running-launch-26715-70719-output.txt");
  prepareFakeApp(nonRunningLaunch2671570719App, "26.715.70719", "5650");
  runScriptCommand(nonRunningLaunch2671570719App, ["launch"], nonRunningLaunch2671570719Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2671570719Output), "Compatibility: supported", "expected build 5650 to pass the strict support gate", readOutput(nonRunningLaunch2671570719Output));
  assertContains(readOutput(nonRunningLaunch2671570719Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5650 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2671570719Output));
  assertContains(readOutput(nonRunningLaunch2671570719Output), "Contents/MacOS/ChatGPT", "expected build 5650 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2671570719Output));
  assertNoLaunchCalls(nonRunningLaunch2671570719Output);
  assertNoBundleMutationTools(nonRunningLaunch2671570719Output);

  const nonRunningLaunch2671572028App = join(tmpDir, "NonRunningLaunch2671572028.app");
  const nonRunningLaunch2671572028Output = join(tmpDir, "non-running-launch-26715-72028-output.txt");
  prepareFakeApp(nonRunningLaunch2671572028App, "26.715.72028", "5706");
  runScriptCommand(nonRunningLaunch2671572028App, ["launch"], nonRunningLaunch2671572028Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2671572028Output), "Compatibility: supported", "expected build 5706 to pass the strict support gate", readOutput(nonRunningLaunch2671572028Output));
  assertContains(readOutput(nonRunningLaunch2671572028Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5706 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2671572028Output));
  assertContains(readOutput(nonRunningLaunch2671572028Output), "Contents/MacOS/ChatGPT", "expected build 5706 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2671572028Output));
  assertNoLaunchCalls(nonRunningLaunch2671572028Output);
  assertNoBundleMutationTools(nonRunningLaunch2671572028Output);
  ...
  const nonRunningLaunch2672181911App = join(tmpDir, "NonRunningLaunch2672181911.app");
  const nonRunningLaunch2672181911Output = join(tmpDir, "non-running-launch-26721-81911-output.txt");
  prepareFakeApp(nonRunningLaunch2672181911App, "26.721.81911", "5973");
  runScriptCommand(nonRunningLaunch2672181911App, ["launch"], nonRunningLaunch2672181911Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2672181911Output), "Compatibility: supported", "expected build 5973 to pass the strict support gate", readOutput(nonRunningLaunch2672181911Output));
  assertContains(readOutput(nonRunningLaunch2672181911Output), "Runtime launch failed: Codex executable not found:", "expected supported build 5973 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2672181911Output));
  assertContains(readOutput(nonRunningLaunch2672181911Output), "Contents/MacOS/ChatGPT", "expected build 5973 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2672181911Output));
  assertNoLaunchCalls(nonRunningLaunch2672181911Output);
  assertNoBundleMutationTools(nonRunningLaunch2672181911Output);
  ...
  const nonRunningLaunch2680341515App = join(tmpDir, "NonRunningLaunch2680341515.app");
  const nonRunningLaunch2680341515Output = join(tmpDir, "non-running-launch-26803-41515-output.txt");
  prepareFakeApp(nonRunningLaunch2680341515App, "26.803.41515", "6321");
  runScriptCommand(nonRunningLaunch2680341515App, ["launch"], nonRunningLaunch2680341515Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2680341515Output), "Compatibility: supported", "expected build 6321 to pass the strict support gate", readOutput(nonRunningLaunch2680341515Output));
  assertContains(readOutput(nonRunningLaunch2680341515Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6321 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2680341515Output));
  assertContains(readOutput(nonRunningLaunch2680341515Output), "Contents/MacOS/ChatGPT", "expected build 6321 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2680341515Output));
  assertNoLaunchCalls(nonRunningLaunch2680341515Output);
  assertNoBundleMutationTools(nonRunningLaunch2680341515Output);

  const nonRunningLaunch2680361601App = join(tmpDir, "NonRunningLaunch2680361601.app");
  const nonRunningLaunch2680361601Output = join(tmpDir, "non-running-launch-26803-61601-output.txt");
  prepareFakeApp(nonRunningLaunch2680361601App, "26.803.61601", "6396");
  runScriptCommand(nonRunningLaunch2680361601App, ["launch"], nonRunningLaunch2680361601Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2680361601Output), "Compatibility: supported", "expected build 6396 to pass the strict support gate", readOutput(nonRunningLaunch2680361601Output));
  assertContains(readOutput(nonRunningLaunch2680361601Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6396 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2680361601Output));
  assertContains(readOutput(nonRunningLaunch2680361601Output), "Contents/MacOS/ChatGPT", "expected build 6396 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2680361601Output));
  assertNoLaunchCalls(nonRunningLaunch2680361601Output);
  assertNoBundleMutationTools(nonRunningLaunch2680361601Output);

  const nonRunningLaunch2681041047App = join(tmpDir, "NonRunningLaunch2681041047.app");
  const nonRunningLaunch2681041047Output = join(tmpDir, "non-running-launch-26810-41047-output.txt");
  prepareFakeApp(nonRunningLaunch2681041047App, "26.810.41047", "6570");
  runScriptCommand(nonRunningLaunch2681041047App, ["launch"], nonRunningLaunch2681041047Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681041047Output), "Compatibility: supported", "expected build 6570 to pass the strict support gate", readOutput(nonRunningLaunch2681041047Output));
  assertContains(readOutput(nonRunningLaunch2681041047Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6570 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681041047Output));
  assertContains(readOutput(nonRunningLaunch2681041047Output), "Contents/MacOS/ChatGPT", "expected build 6570 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681041047Output));
  assertNoLaunchCalls(nonRunningLaunch2681041047Output);
  assertNoBundleMutationTools(nonRunningLaunch2681041047Output);

  const nonRunningLaunch2681052044App = join(tmpDir, "NonRunningLaunch2681052044.app");
  const nonRunningLaunch2681052044Output = join(tmpDir, "non-running-launch-26810-52044-output.txt");
  prepareFakeApp(nonRunningLaunch2681052044App, "26.810.52044", "6662");
  runScriptCommand(nonRunningLaunch2681052044App, ["launch"], nonRunningLaunch2681052044Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681052044Output), "Compatibility: supported", "expected build 6662 to pass the strict support gate", readOutput(nonRunningLaunch2681052044Output));
  assertContains(readOutput(nonRunningLaunch2681052044Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6662 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681052044Output));
  assertContains(readOutput(nonRunningLaunch2681052044Output), "Contents/MacOS/ChatGPT", "expected build 6662 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681052044Output));
  assertNoLaunchCalls(nonRunningLaunch2681052044Output);
  assertNoBundleMutationTools(nonRunningLaunch2681052044Output);

  const nonRunningLaunch2681441407App = join(tmpDir, "NonRunningLaunch2681441407.app");
  const nonRunningLaunch2681441407Output = join(tmpDir, "non-running-launch-26814-41407-output.txt");
  prepareFakeApp(nonRunningLaunch2681441407App, "26.814.41407", "6720");
  runScriptCommand(nonRunningLaunch2681441407App, ["launch"], nonRunningLaunch2681441407Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681441407Output), "Compatibility: supported", "expected build 6720 to pass the strict support gate", readOutput(nonRunningLaunch2681441407Output));
  assertContains(readOutput(nonRunningLaunch2681441407Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6720 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681441407Output));
  assertContains(readOutput(nonRunningLaunch2681441407Output), "Contents/MacOS/ChatGPT", "expected build 6720 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681441407Output));
  assertNoLaunchCalls(nonRunningLaunch2681441407Output);
  assertNoBundleMutationTools(nonRunningLaunch2681441407Output);

  const nonRunningLaunch2681831338App = join(tmpDir, "NonRunningLaunch2681831338.app");
  const nonRunningLaunch2681831338Output = join(tmpDir, "non-running-launch-26818-31338-output.txt");
  prepareFakeApp(nonRunningLaunch2681831338App, "26.818.31338", "6892");
  runScriptCommand(nonRunningLaunch2681831338App, ["launch"], nonRunningLaunch2681831338Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681831338Output), "Compatibility: supported", "expected build 6892 to pass the strict support gate", readOutput(nonRunningLaunch2681831338Output));
  assertContains(readOutput(nonRunningLaunch2681831338Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6892 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681831338Output));
  assertContains(readOutput(nonRunningLaunch2681831338Output), "Contents/MacOS/ChatGPT", "expected build 6892 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681831338Output));
  assertNoLaunchCalls(nonRunningLaunch2681831338Output);
  assertNoBundleMutationTools(nonRunningLaunch2681831338Output);

  const nonRunningLaunch2681841509App = join(tmpDir, "NonRunningLaunch2681841509.app");
  const nonRunningLaunch2681841509Output = join(tmpDir, "non-running-launch-26818-41509-output.txt");
  prepareFakeApp(nonRunningLaunch2681841509App, "26.818.41509", "6962");
  runScriptCommand(nonRunningLaunch2681841509App, ["launch"], nonRunningLaunch2681841509Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681841509Output), "Compatibility: supported", "expected build 6962 to pass the strict support gate", readOutput(nonRunningLaunch2681841509Output));
  assertContains(readOutput(nonRunningLaunch2681841509Output), "Runtime launch failed: Codex executable not found:", "expected supported build 6962 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681841509Output));
  assertContains(readOutput(nonRunningLaunch2681841509Output), "Contents/MacOS/ChatGPT", "expected build 6962 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681841509Output));
  assertNoLaunchCalls(nonRunningLaunch2681841509Output);
  assertNoBundleMutationTools(nonRunningLaunch2681841509Output);

  const nonRunningLaunch2681861809App = join(tmpDir, "NonRunningLaunch2681861809.app");
  const nonRunningLaunch2681861809Output = join(tmpDir, "non-running-launch-26818-61809-output.txt");
  prepareFakeApp(nonRunningLaunch2681861809App, "26.818.61809", "7019");
  runScriptCommand(nonRunningLaunch2681861809App, ["launch"], nonRunningLaunch2681861809Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2681861809Output), "Compatibility: supported", "expected build 7019 to pass the strict support gate", readOutput(nonRunningLaunch2681861809Output));
  assertContains(readOutput(nonRunningLaunch2681861809Output), "Runtime launch failed: Codex executable not found:", "expected supported build 7019 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2681861809Output));
  assertContains(readOutput(nonRunningLaunch2681861809Output), "Contents/MacOS/ChatGPT", "expected build 7019 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2681861809Output));
  assertNoLaunchCalls(nonRunningLaunch2681861809Output);
  assertNoBundleMutationTools(nonRunningLaunch2681861809Output);

  const nonRunningLaunch2682060940App = join(tmpDir, "NonRunningLaunch2682060940.app");
  const nonRunningLaunch2682060940Output = join(tmpDir, "non-running-launch-26820-60940-output.txt");
  prepareFakeApp(nonRunningLaunch2682060940App, "26.820.60940", "7119");
  runScriptCommand(nonRunningLaunch2682060940App, ["launch"], nonRunningLaunch2682060940Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2682060940Output), "Compatibility: supported", "expected build 7119 to pass the strict support gate", readOutput(nonRunningLaunch2682060940Output));
  assertContains(readOutput(nonRunningLaunch2682060940Output), "Runtime launch failed: Codex executable not found:", "expected supported build 7119 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2682060940Output));
  assertContains(readOutput(nonRunningLaunch2682060940Output), "Contents/MacOS/ChatGPT", "expected build 7119 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2682060940Output));
  assertNoLaunchCalls(nonRunningLaunch2682060940Output);
  assertNoBundleMutationTools(nonRunningLaunch2682060940Output);

  const nonRunningLaunch2682541651App = join(tmpDir, "NonRunningLaunch2682541651.app");
  const nonRunningLaunch2682541651Output = join(tmpDir, "non-running-launch-26825-41651-output.txt");
  prepareFakeApp(nonRunningLaunch2682541651App, "26.825.41651", "7345");
  runScriptCommand(nonRunningLaunch2682541651App, ["launch"], nonRunningLaunch2682541651Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2682541651Output), "Compatibility: supported", "expected build 7345 to pass the strict support gate", readOutput(nonRunningLaunch2682541651Output));
  assertContains(readOutput(nonRunningLaunch2682541651Output), "Runtime launch failed: Codex executable not found:", "expected supported build 7345 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2682541651Output));
  assertContains(readOutput(nonRunningLaunch2682541651Output), "Contents/MacOS/ChatGPT", "expected build 7345 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2682541651Output));
  assertNoLaunchCalls(nonRunningLaunch2682541651Output);
  assertNoBundleMutationTools(nonRunningLaunch2682541651Output);

  const nonRunningLaunch2682551511App = join(tmpDir, "NonRunningLaunch2682551511.app");
  const nonRunningLaunch2682551511Output = join(tmpDir, "non-running-launch-26825-51511-output.txt");
  prepareFakeApp(nonRunningLaunch2682551511App, "26.825.51511", "7377");
  runScriptCommand(nonRunningLaunch2682551511App, ["launch"], nonRunningLaunch2682551511Output, { CODEXFAST_TEST_ALLOW_NONZERO: "1" });
  assertContains(readOutput(nonRunningLaunch2682551511Output), "Compatibility: supported", "expected build 7377 to pass the strict support gate", readOutput(nonRunningLaunch2682551511Output));
  assertContains(readOutput(nonRunningLaunch2682551511Output), "Runtime launch failed: Codex executable not found:", "expected supported build 7377 fixture to fail only at its missing executable", readOutput(nonRunningLaunch2682551511Output));
  assertContains(readOutput(nonRunningLaunch2682551511Output), "Contents/MacOS/ChatGPT", "expected build 7377 launch failure to list the ChatGPT executable fallback path", readOutput(nonRunningLaunch2682551511Output));
  assertNoLaunchCalls(nonRunningLaunch2682551511Output);
  assertNoBundleMutationTools(nonRunningLaunch2682551511Output);
  ...
  const launchPendingTargets2671531925App = join(tmpDir, "LaunchPendingTargets2671531925.app");
  const launchPendingTargets2671531925Output = join(tmpDir, "launch-pending-targets-26715-31925-output.txt");
  prepareFakeApp(launchPendingTargets2671531925App, "26.715.31925", "5551");
  runScriptCommand(launchPendingTargets2671531925App, ["launch"], launchPendingTargets2671531925Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2671531925Output), "Runtime patch interception did not observe required targets: none.", "expected build 5551 not to require the legacy Plugins access target", readOutput(launchPendingTargets2671531925Output));
  assertNotContains(readOutput(launchPendingTargets2671531925Output), "Plugins access", "expected build 5551 missing-target output not to name Plugins access", readOutput(launchPendingTargets2671531925Output));
  assertNoLaunchCalls(launchPendingTargets2671531925Output);
  assertNoBundleMutationTools(launchPendingTargets2671531925Output);

  const launchPendingTargets2671552143App = join(tmpDir, "LaunchPendingTargets2671552143.app");
  const launchPendingTargets2671552143Output = join(tmpDir, "launch-pending-targets-26715-52143-output.txt");
  prepareFakeApp(launchPendingTargets2671552143App, "26.715.52143", "5591");
  runScriptCommand(launchPendingTargets2671552143App, ["launch"], launchPendingTargets2671552143Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2671552143Output), "Runtime patch interception did not observe required targets: none.", "expected build 5591 not to require the legacy Plugins access target", readOutput(launchPendingTargets2671552143Output));
  assertNotContains(readOutput(launchPendingTargets2671552143Output), "Plugins access", "expected build 5591 missing-target output not to name Plugins access", readOutput(launchPendingTargets2671552143Output));
  assertNoLaunchCalls(launchPendingTargets2671552143Output);
  assertNoBundleMutationTools(launchPendingTargets2671552143Output);

  const launchPendingTargets2671561943App = join(tmpDir, "LaunchPendingTargets2671561943.app");
  const launchPendingTargets2671561943Output = join(tmpDir, "launch-pending-targets-26715-61943-output.txt");
  prepareFakeApp(launchPendingTargets2671561943App, "26.715.61943", "5628");
  runScriptCommand(launchPendingTargets2671561943App, ["launch"], launchPendingTargets2671561943Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2671561943Output), "Runtime patch interception did not observe required targets: none.", "expected build 5628 not to require the legacy Plugins access target", readOutput(launchPendingTargets2671561943Output));
  assertNotContains(readOutput(launchPendingTargets2671561943Output), "Plugins access", "expected build 5628 missing-target output not to name Plugins access", readOutput(launchPendingTargets2671561943Output));
  assertNoLaunchCalls(launchPendingTargets2671561943Output);
  assertNoBundleMutationTools(launchPendingTargets2671561943Output);

  const launchPendingTargets2671570719App = join(tmpDir, "LaunchPendingTargets2671570719.app");
  const launchPendingTargets2671570719Output = join(tmpDir, "launch-pending-targets-26715-70719-output.txt");
  prepareFakeApp(launchPendingTargets2671570719App, "26.715.70719", "5650");
  runScriptCommand(launchPendingTargets2671570719App, ["launch"], launchPendingTargets2671570719Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2671570719Output), "Runtime patch interception did not observe required targets: none.", "expected build 5650 not to require the legacy Plugins access target", readOutput(launchPendingTargets2671570719Output));
  assertNotContains(readOutput(launchPendingTargets2671570719Output), "Plugins access", "expected build 5650 missing-target output not to name Plugins access", readOutput(launchPendingTargets2671570719Output));
  assertNoLaunchCalls(launchPendingTargets2671570719Output);
  assertNoBundleMutationTools(launchPendingTargets2671570719Output);

  const launchPendingTargets2671572028App = join(tmpDir, "LaunchPendingTargets2671572028.app");
  const launchPendingTargets2671572028Output = join(tmpDir, "launch-pending-targets-26715-72028-output.txt");
  prepareFakeApp(launchPendingTargets2671572028App, "26.715.72028", "5706");
  runScriptCommand(launchPendingTargets2671572028App, ["launch"], launchPendingTargets2671572028Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2671572028Output), "Runtime patch interception did not observe required targets: none.", "expected build 5706 not to require the legacy Plugins access target", readOutput(launchPendingTargets2671572028Output));
  assertNotContains(readOutput(launchPendingTargets2671572028Output), "Plugins access", "expected build 5706 missing-target output not to name Plugins access", readOutput(launchPendingTargets2671572028Output));
  assertNoLaunchCalls(launchPendingTargets2671572028Output);
  assertNoBundleMutationTools(launchPendingTargets2671572028Output);
  ...
  const launchPendingTargets2672181911App = join(tmpDir, "LaunchPendingTargets2672181911.app");
  const launchPendingTargets2672181911Output = join(tmpDir, "launch-pending-targets-26721-81911-output.txt");
  prepareFakeApp(launchPendingTargets2672181911App, "26.721.81911", "5973");
  runScriptCommand(launchPendingTargets2672181911App, ["launch"], launchPendingTargets2672181911Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2672181911Output), "Runtime patch interception did not observe required targets: none.", "expected build 5973 not to require the legacy Plugins access target", readOutput(launchPendingTargets2672181911Output));
  assertNotContains(readOutput(launchPendingTargets2672181911Output), "Plugins access", "expected build 5973 missing-target output not to name Plugins access", readOutput(launchPendingTargets2672181911Output));
  assertNoLaunchCalls(launchPendingTargets2672181911Output);
  assertNoBundleMutationTools(launchPendingTargets2672181911Output);
  ...
  const launchPendingTargets2680341515App = join(tmpDir, "LaunchPendingTargets2680341515.app");
  const launchPendingTargets2680341515Output = join(tmpDir, "launch-pending-targets-26803-41515-output.txt");
  prepareFakeApp(launchPendingTargets2680341515App, "26.803.41515", "6321");
  runScriptCommand(launchPendingTargets2680341515App, ["launch"], launchPendingTargets2680341515Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2680341515Output), "Runtime patch interception did not observe required targets: none.", "expected build 6321 not to require the legacy Plugins access target", readOutput(launchPendingTargets2680341515Output));
  assertNotContains(readOutput(launchPendingTargets2680341515Output), "Plugins access", "expected build 6321 missing-target output not to name Plugins access", readOutput(launchPendingTargets2680341515Output));
  assertNoLaunchCalls(launchPendingTargets2680341515Output);
  assertNoBundleMutationTools(launchPendingTargets2680341515Output);

  const launchPendingTargets2680361601App = join(tmpDir, "LaunchPendingTargets2680361601.app");
  const launchPendingTargets2680361601Output = join(tmpDir, "launch-pending-targets-26803-61601-output.txt");
  prepareFakeApp(launchPendingTargets2680361601App, "26.803.61601", "6396");
  runScriptCommand(launchPendingTargets2680361601App, ["launch"], launchPendingTargets2680361601Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2680361601Output), "Runtime patch interception did not observe required targets: none.", "expected build 6396 not to require the legacy Plugins access target", readOutput(launchPendingTargets2680361601Output));
  assertNotContains(readOutput(launchPendingTargets2680361601Output), "Plugins access", "expected build 6396 missing-target output not to name Plugins access", readOutput(launchPendingTargets2680361601Output));
  assertNoLaunchCalls(launchPendingTargets2680361601Output);
  assertNoBundleMutationTools(launchPendingTargets2680361601Output);

  const launchPendingTargets2681041047App = join(tmpDir, "LaunchPendingTargets2681041047.app");
  const launchPendingTargets2681041047Output = join(tmpDir, "launch-pending-targets-26810-41047-output.txt");
  prepareFakeApp(launchPendingTargets2681041047App, "26.810.41047", "6570");
  runScriptCommand(launchPendingTargets2681041047App, ["launch"], launchPendingTargets2681041047Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681041047Output), "Runtime patch interception did not observe required targets: none.", "expected build 6570 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681041047Output));
  assertNotContains(readOutput(launchPendingTargets2681041047Output), "Plugins access", "expected build 6570 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681041047Output));
  assertNoLaunchCalls(launchPendingTargets2681041047Output);
  assertNoBundleMutationTools(launchPendingTargets2681041047Output);

  const launchPendingTargets2681052044App = join(tmpDir, "LaunchPendingTargets2681052044.app");
  const launchPendingTargets2681052044Output = join(tmpDir, "launch-pending-targets-26810-52044-output.txt");
  prepareFakeApp(launchPendingTargets2681052044App, "26.810.52044", "6662");
  runScriptCommand(launchPendingTargets2681052044App, ["launch"], launchPendingTargets2681052044Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681052044Output), "Runtime patch interception did not observe required targets: none.", "expected build 6662 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681052044Output));
  assertNotContains(readOutput(launchPendingTargets2681052044Output), "Plugins access", "expected build 6662 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681052044Output));
  assertNoLaunchCalls(launchPendingTargets2681052044Output);
  assertNoBundleMutationTools(launchPendingTargets2681052044Output);

  const launchPendingTargets2681441407App = join(tmpDir, "LaunchPendingTargets2681441407.app");
  const launchPendingTargets2681441407Output = join(tmpDir, "launch-pending-targets-26814-41407-output.txt");
  prepareFakeApp(launchPendingTargets2681441407App, "26.814.41407", "6720");
  runScriptCommand(launchPendingTargets2681441407App, ["launch"], launchPendingTargets2681441407Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681441407Output), "Runtime patch interception did not observe required targets: none.", "expected build 6720 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681441407Output));
  assertNotContains(readOutput(launchPendingTargets2681441407Output), "Plugins access", "expected build 6720 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681441407Output));
  assertNoLaunchCalls(launchPendingTargets2681441407Output);
  assertNoBundleMutationTools(launchPendingTargets2681441407Output);

  const launchPendingTargets2681831338App = join(tmpDir, "LaunchPendingTargets2681831338.app");
  const launchPendingTargets2681831338Output = join(tmpDir, "launch-pending-targets-26818-31338-output.txt");
  prepareFakeApp(launchPendingTargets2681831338App, "26.818.31338", "6892");
  runScriptCommand(launchPendingTargets2681831338App, ["launch"], launchPendingTargets2681831338Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681831338Output), "Runtime patch interception did not observe required targets: none.", "expected build 6892 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681831338Output));
  assertNotContains(readOutput(launchPendingTargets2681831338Output), "Plugins access", "expected build 6892 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681831338Output));
  assertNoLaunchCalls(launchPendingTargets2681831338Output);
  assertNoBundleMutationTools(launchPendingTargets2681831338Output);

  const launchPendingTargets2681841509App = join(tmpDir, "LaunchPendingTargets2681841509.app");
  const launchPendingTargets2681841509Output = join(tmpDir, "launch-pending-targets-26818-41509-output.txt");
  prepareFakeApp(launchPendingTargets2681841509App, "26.818.41509", "6962");
  runScriptCommand(launchPendingTargets2681841509App, ["launch"], launchPendingTargets2681841509Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681841509Output), "Runtime patch interception did not observe required targets: none.", "expected build 6962 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681841509Output));
  assertNotContains(readOutput(launchPendingTargets2681841509Output), "Plugins access", "expected build 6962 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681841509Output));
  assertNoLaunchCalls(launchPendingTargets2681841509Output);
  assertNoBundleMutationTools(launchPendingTargets2681841509Output);

  const launchPendingTargets2681861809App = join(tmpDir, "LaunchPendingTargets2681861809.app");
  const launchPendingTargets2681861809Output = join(tmpDir, "launch-pending-targets-26818-61809-output.txt");
  prepareFakeApp(launchPendingTargets2681861809App, "26.818.61809", "7019");
  runScriptCommand(launchPendingTargets2681861809App, ["launch"], launchPendingTargets2681861809Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2681861809Output), "Runtime patch interception did not observe required targets: none.", "expected build 7019 not to require the legacy Plugins access target", readOutput(launchPendingTargets2681861809Output));
  assertNotContains(readOutput(launchPendingTargets2681861809Output), "Plugins access", "expected build 7019 missing-target output not to name Plugins access", readOutput(launchPendingTargets2681861809Output));
  assertNoLaunchCalls(launchPendingTargets2681861809Output);
  assertNoBundleMutationTools(launchPendingTargets2681861809Output);

  const launchPendingTargets2682060940App = join(tmpDir, "LaunchPendingTargets2682060940.app");
  const launchPendingTargets2682060940Output = join(tmpDir, "launch-pending-targets-26820-60940-output.txt");
  prepareFakeApp(launchPendingTargets2682060940App, "26.820.60940", "7119");
  runScriptCommand(launchPendingTargets2682060940App, ["launch"], launchPendingTargets2682060940Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2682060940Output), "Runtime patch interception did not observe required targets: none.", "expected build 7119 not to require the legacy Plugins access target", readOutput(launchPendingTargets2682060940Output));
  assertNotContains(readOutput(launchPendingTargets2682060940Output), "Plugins access", "expected build 7119 missing-target output not to name Plugins access", readOutput(launchPendingTargets2682060940Output));
  assertNoLaunchCalls(launchPendingTargets2682060940Output);
  assertNoBundleMutationTools(launchPendingTargets2682060940Output);

  const launchPendingTargets2682541651App = join(tmpDir, "LaunchPendingTargets2682541651.app");
  const launchPendingTargets2682541651Output = join(tmpDir, "launch-pending-targets-26825-41651-output.txt");
  prepareFakeApp(launchPendingTargets2682541651App, "26.825.41651", "7345");
  runScriptCommand(launchPendingTargets2682541651App, ["launch"], launchPendingTargets2682541651Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2682541651Output), "Runtime patch interception did not observe required targets: none.", "expected build 7345 not to require the legacy Plugins access target", readOutput(launchPendingTargets2682541651Output));
  assertNotContains(readOutput(launchPendingTargets2682541651Output), "Plugins access", "expected build 7345 missing-target output not to name Plugins access", readOutput(launchPendingTargets2682541651Output));
  assertNoLaunchCalls(launchPendingTargets2682541651Output);
  assertNoBundleMutationTools(launchPendingTargets2682541651Output);

  const launchPendingTargets2682551511App = join(tmpDir, "LaunchPendingTargets2682551511.app");
  const launchPendingTargets2682551511Output = join(tmpDir, "launch-pending-targets-26825-51511-output.txt");
  prepareFakeApp(launchPendingTargets2682551511App, "26.825.51511", "7377");
  runScriptCommand(launchPendingTargets2682551511App, ["launch"], launchPendingTargets2682551511Output, {
    CODEXFAST_TEST_RUNTIME_LAUNCH_PENDING_TARGETS: "1",
    CODEXFAST_TEST_ALLOW_NONZERO: "1",
  });
  assertContains(readOutput(launchPendingTargets2682551511Output), "Runtime patch interception did not observe required targets: none.", "expected build 7377 not to require the legacy Plugins access target", readOutput(launchPendingTargets2682551511Output));
  assertNotContains(readOutput(launchPendingTargets2682551511Output), "Plugins access", "expected build 7377 missing-target output not to name Plugins access", readOutput(launchPendingTargets2682551511Output));
  assertNoLaunchCalls(launchPendingTargets2682551511Output);
  assertNoBundleMutationTools(launchPendingTargets2682551511Output);
