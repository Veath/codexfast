...
export function runRuntimePatchSuite(): void {
  ...
  assertContains(serviceTierConversationFallback26608Result.content, "t=a!=null&&w?.params.serviceTier!==void 0?w.params.serviceTier:D.serviceTier", "expected conversation-level service tier to fall back to the configured default tier");
  assertContains(serviceTierConversationFallback26608Result.content, "z=a!=null&&w?.params.serviceTier!==void 0?I?t:null:l(e,t,I)", "expected only route params to override the configured default tier");
