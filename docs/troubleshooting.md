...
- On `26.623.31443` (`build 4441`), `26.623.31921` (`build 4452`), `26.623.42026` (`build 4514`), `26.623.61825` (`build 4548`), `26.623.70822` (`build 4559`), `26.623.81905` (`build 4598`), `26.623.101652` (`build 4674`), `26.623.141536` (`build 4753`), `26.707.31428` (`build 5059`), `26.707.41301` (`build 5103`), `26.707.61608` (`build 5200`), `26.707.71524` (`build 5263`), `26.707.72221` (`build 5307`), and `26.707.91948` (`build 5440`), codexfast skips Plugins runtime targets because Plugins is supported by the official app path for this repo's target use case. For those builds, inspect upstream plugin state or connector behavior before looking for codexfast Plugins patch misses.
