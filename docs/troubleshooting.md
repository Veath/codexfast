...
- `26.721.31836`, `26.721.41059`, and `26.721.81911` also skip the legacy `Plugins access` initial target because Plugins uses the official app path.
...
- On `26.721.31836` (`build 5828`), `26.721.41059` (`build 5848`), and `26.721.81911` (`build 5973`), codexfast also skips Plugins runtime targets because Plugins is supported by the official app path for this repo's target use case.
...
Builds `26.715.21425+5488`, `26.715.31925+5551`, `26.715.52143+5591`, `26.715.61943+5628`, `26.715.70719+5650`, `26.715.72028+5706`, `26.715.72359+5718`, `26.721.30844+5813`, `26.721.31836+5828`, `26.721.41059+5848`, and `26.721.81911+5973` use the official Plugins path and do not require the legacy `Plugins access` initial target or Plugins runtime target family.
