...
| --- | --- | --- | --- | --- | --- |
| `26.415.40636` | `1799` | `supported` | Settings Fast, `/fast`, Add-context Speed menu, Plugins access | `2026-04-20` | Matches the current strict whitelist in `src/patcher.mts`. |
...
- When support status changes, update both this file and the whitelist in `src/patcher.mts`.
