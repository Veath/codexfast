...
Latest verified local build: `ChatGPT.app` / `Codex.app` `26.814.41407` (`build 6720`). This build keeps the runtime automatic-update hook and settings schema, but does not ship the renderer `Disable automatic updates` row.

Also verified for `ChatGPT.app` / `Codex.app` `26.810.52044` (`build 6662`), `26.810.41047` (`build 6570`), `26.803.61601` (`build 6396`), `26.803.41515` (`build 6321`), `26.730.61639` (`build 6234`), and `26.730.61309` (`build 6223`).
