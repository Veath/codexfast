...
Latest verified local build: `ChatGPT.app` / `Codex.app` `26.818.31338` (`build 6892`). This build keeps the runtime automatic-update hook and settings schema, but does not ship the renderer `Disable automatic updates` row.
