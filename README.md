...
Latest verified local build: `ChatGPT.app` / `Codex.app` `26.721.81911` (`build 5973`).

Also verified for `ChatGPT.app` / `Codex.app` `26.721.41059` (`build 5848`), `26.721.31836` (`build 5828`), `26.721.30844` (`build 5813`), `26.715.72359` (`build 5718`), and `26.715.72028` (`build 5706`).
